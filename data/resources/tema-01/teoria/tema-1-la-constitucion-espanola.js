const tema1ConstitucionEspanola = {
  schemaVersion: 1,
  ...
  fuente: {
    tipo: "pdf",
    archivo: "TEMA 1 LA CONSTITUCIÓN ESPAÑOLA.pdf",
    paginas: 8,
  },
  bloques: [
    {
      ...
      elementos: [
        { titulo: "Preámbulo" },
        { titulo: "Título Preliminar", articulos: "1 al 9" },
        {
          titulo: "Título Primero",
          subtitulo: "De los Derechos y Deberes Fundamentales",
          elementos: [
            { titulo: "Artículo 10" },
            {
              titulo: "Capítulo Primero",
              subtitulo: "De los españoles y los extranjeros",
              articulos: "11 a 13",
            },
            {
              titulo: "Capítulo II",
              subtitulo: "Derechos y libertades",
              elementos: [
                { titulo: "Artículo 14" },
                {
                  titulo: "Sección 1.ª",
                ...
                {
                  titulo: "Sección 2.ª",
                  subtitulo: "De los derechos y deberes de los ciudadanos",
                  articulos: "30 a 38",
                },
              ],
            },
            ...
            {
              titulo: "Capítulo V",
              subtitulo: "De la suspensión de los derechos y libertades",
              articulos: "55",
            },
          ],
        },
        { titulo: "Título II", subtitulo: "De la Corona", articulos: "56 a 65" },
        {
          titulo: "Título III",
          subtitulo: "De las Cortes Generales",
          elementos: [
            { titulo: "Capítulo Primero", subtitulo: "De las Cámaras", articulos: "66 a 80" },
            {
              titulo: "Capítulo II",
              subtitulo: "De la elaboración de las leyes",
              articulos: "81 a 92",
            },
            {
              titulo: "Capítulo III",
              subtitulo: "De los tratados internacionales",
              articulos: "93 a 96",
            },
          ],
        },
        {
          titulo: "Título IV",
          subtitulo: "Del Gobierno y de la Administración",
          articulos: "97 a 107",
        },
        {
          titulo: "Título V",
          subtitulo: "De las relaciones entre el Gobierno y las Cortes Generales",
          articulos: "108 a 116",
        },
        { titulo: "Título VI", subtitulo: "Del Poder Judicial", articulos: "117 a 127" },
        { titulo: "Título VII", subtitulo: "Economía y Hacienda", articulos: "128 a 136" },
        {
          titulo: "Título VIII",
          subtitulo: "De la organización territorial del Estado",
          elementos: [
            {
              titulo: "Capítulo Primero",
              subtitulo: "Principios generales",
              articulos: "137 a 139",
            },
            {
              titulo: "Capítulo II",
              subtitulo: "De la Administración local",
              articulos: "140 a 142",
            },
            {
              titulo: "Capítulo III",
              subtitulo: "De las Comunidades Autónomas",
              articulos: "143 a 158",
            },
          ],
        },
        {
          titulo: "Título IX",
          subtitulo: "Del Tribunal Constitucional",
          articulos: "159 a 165",
        },
        {
          titulo: "Título X",
          subtitulo: "De la reforma constitucional",
          articulos: "166 a 169",
        },
        { titulo: "Disposiciones adicionales", cantidad: 4 },
        { titulo: "Disposiciones transitorias", cantidad: 9 },
        { titulo: "Disposiciones derogatorias", cantidad: 1 },
        { titulo: "Disposiciones finales", cantidad: 1 },
      ],
      promulgacion:
    ...
    },
    {
      ...
      contenido: [
        ...
        },
        {
          tipo: "capitulo",
          numero: "I",
          titulo: "De los españoles y los extranjeros",
          articulos: [
            {
              numero: 11,
              apartados: [
        ...
        },
        {
          ...
          contenido: [
            ...
            },
            {
              tipo: "seccion",
              numero: "1.ª",
              titulo: "De los derechos fundamentales y de las libertades públicas",
              articulos: [
                {
                  numero: 15,
                  texto:
                ...
                },
                {
                  ...
                  apartados: [
                    {
                      numero: 1,
                      texto: "Se reconocen y protegen los derechos:",
                      letras: [
                        {
                          letra: "a",
                          texto:
                        ...
                        { letra: "c", texto: "A la libertad de cátedra." },
                        {
                          letra: "d",
                          texto:
                ...
                },
                {
                  numero: 22,
                  apartados: [
                    { numero: 1, texto: "Se reconoce el derecho de asociación." },
                    {
                      numero: 2,
                      texto:
                ...
                },
                {
                  ...
                  apartados: [
                    ...
                    { numero: 4, texto: "La enseñanza básica es obligatoria y gratuita." },
                    {
                      numero: 5,
                      texto:
            ...
            },
            {
              tipo: "seccion",
              numero: "2.ª",
              titulo: "De los derechos y deberes de los ciudadanos",
              articulos: [
                {
                  numero: 30,
                  apartados: [
                ...
                },
                {
                  ...
                  apartados: [
                    ...
                    { numero: 2, texto: "La ley regulará un estatuto de los trabajadores." },
                  ],
                },
                {
                  numero: 36,
        ...
        },
        {
          tipo: "capitulo",
          numero: "III",
          titulo: "De los principios rectores de la política social y económica",
          articulos: [
            {
              numero: 39,
              apartados: [
            ...
            },
            {
              numero: 43,
              apartados: [
                { numero: 1, texto: "Se reconoce el derecho a la protección de la salud." },
                {
                  numero: 2,
                  texto:
              ...
              apartados: [
                {
                  numero: 1,
                  texto:
                    "Los poderes públicos promoverán y tutelará el acceso a la cultura, a la que todos tienen derecho.",
                },
                {
                  numero: 2,
                  texto:
        ...
        },
        {
          tipo: "capitulo",
          numero: "IV",
          titulo: "De las garantías de las libertades y derechos fundamentales",
          articulos: [
            {
              numero: 53,
              apartados: [
        ...
        },
        {
          tipo: "capitulo",
          numero: "V",
          titulo: "De la suspensión de los derechos y libertades",
          articulos: [
            {
              numero: 55,
              apartados: [
...
export default tema1ConstitucionEspanola;
