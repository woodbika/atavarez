const tema2OrganizacionTerritorial = {
  schemaVersion: 1,
  ...
  bloques: [
    {
      ...
      tipo: "titulo",
      numero: "VIII",
      titulo: "De la Organización Territorial del Estado",
      contenido: [
        {
          tipo: "capitulo",
          numero: "I",
        ...
        },
        {
          tipo: "capitulo",
          numero: "II",
          titulo: "De la Administración Local",
          articulos: [
            {
              numero: 140,
              texto:
        ...
        },
        {
          tipo: "capitulo",
          numero: "III",
          titulo: "De las Comunidades Autónomas",
          articulos: [
            {
              numero: 143,
              apartados: [
            ...
            },
            {
              ...
              apartados: [
                ...
                {
                  numero: 2,
                  texto: "Los Estatutos de autonomía deberán contener:",
                  letras: [
                    {
                      letra: "a",
                      texto:
                    ...
                    { letra: "b", texto: "La delimitación de su territorio." },
                    {
                      letra: "c",
                      texto:
              ...
              apartados: [
                {
                  ...
                  ordinales: [
                    { ordinal: "1.ª", texto: "Organización de sus instituciones de autogobierno." },
                    {
                      ordinal: "2.ª",
                      texto:
                    ...
                    { ordinal: "3.ª", texto: "Ordenación del territorio, urbanismo y vivienda." },
                    {
                      ordinal: "4.ª",
                      texto:
                    ...
                    { ordinal: "8.ª", texto: "Los montes y aprovechamientos forestales." },
                    {
                      ordinal: "9.ª",
                      texto: "La gestión en materia de protección del medio ambiente.",
                    },
                    {
                      ordinal: "10.ª",
                      texto:
                    ...
                    { ordinal: "12.ª", texto: "Ferias interiores." },
                    {
                      ordinal: "13.ª",
                      texto:
                    ...
                    { ordinal: "14.ª", texto: "La artesanía." },
                    {
                      ordinal: "15.ª",
                      texto:
                    ...
                    {
                      ordinal: "16.ª",
                      texto: "Patrimonio monumental de interés de la Comunidad Autónoma.",
                    },
                    {
                      ordinal: "17.ª",
                      texto:
                    ...
                    {
                      ordinal: "18.ª",
                      texto: "Promoción y ordenación del turismo en su ámbito territorial.",
                    },
                    {
                      ordinal: "19.ª",
                      texto: "Promoción del deporte y de la adecuada utilización del ocio.",
                    },
                    { ordinal: "20.ª", texto: "Asistencia social." },
                    { ordinal: "21.ª", texto: "Sanidad e higiene." },
                    {
                      ordinal: "22.ª",
                      texto:
            ...
            },
            {
              ...
              apartados: [
                {
                  numero: 1,
                  texto: "El Estado tiene competencia exclusiva sobre las siguientes materias:",
                  ordinales: [
                    {
                      ordinal: "1.ª",
                      texto:
                    ...
                    {
                      ordinal: "2.ª",
                      texto: "Nacionalidad, inmigración, emigración, extranjería y derecho de asilo.",
                    },
                    { ordinal: "3.ª", texto: "Relaciones internacionales." },
                    { ordinal: "4.ª", texto: "Defensa y Fuerzas Armadas." },
                    { ordinal: "5.ª", texto: "Administración de Justicia." },
                    {
                      ordinal: "6.ª",
                      texto:
                    ...
                    {
                      ordinal: "9.ª",
                      texto: "Legislación sobre propiedad intelectual e industrial.",
                    },
                    { ordinal: "10.ª", texto: "Régimen aduanero y arancelario; comercio exterior." },
                    {
                      ordinal: "11.ª",
                      texto:
                    ...
                    {
                      ordinal: "12.ª",
                      texto: "Legislación sobre pesas y medidas, determinación de la hora oficial.",
                    },
                    {
                      ordinal: "13.ª",
                      texto: "Bases y coordinación de la planificación general de la actividad económica.",
                    },
                    { ordinal: "14.ª", texto: "Hacienda general y Deuda del Estado." },
                    {
                      ordinal: "15.ª",
                      texto: "Fomento y coordinación general de la investigación científica y técnica.",
                    },
                    {
                      ordinal: "16.ª",
                      texto:
                    ...
                    { ordinal: "25.ª", texto: "Bases de régimen minero y energético." },
                    {
                      ordinal: "26.ª",
                      texto: "Régimen de producción, comercio, tenencia y uso de armas y explosivos.",
                    },
                    {
                      ordinal: "27.ª",
                      texto:
                    ...
                    { ordinal: "31.ª", texto: "Estadística para fines estatales." },
                    {
                      ordinal: "32.ª",
                      texto: "Autorización para la convocatoria de consultas populares por vía de referéndum.",
                    },
                  ],
                },
                {
            ...
            },
            {
              ...
              letras: [
                ...
                {
                  letra: "d",
                  texto: "Por el Tribunal de Cuentas, el económico y presupuestario.",
                },
              ],
            },
            {
            ...
            },
            {
              ...
              apartados: [
                {
                  numero: 1,
                  texto: "Los recursos de las Comunidades Autónomas estarán constituidos por:",
                  letras: [
                    {
                      letra: "a",
                      texto:
                    ...
                    {
                      letra: "b",
                      texto: "Sus propios impuestos, tasas y contribuciones especiales.",
                    },
                    {
                      letra: "c",
                      texto:
                    ...
                    { letra: "e", texto: "El producto de las operaciones de crédito." },
                  ],
                },
                {
                  numero: 2,
...
export default tema2OrganizacionTerritorial;
